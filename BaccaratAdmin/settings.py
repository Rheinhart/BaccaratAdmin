"""
Django settings for BaccaratAdmin project.
...
INSTALLED_APPS = (
    ...
    'BaccaratAdmin.userinfo',
    'BaccaratAdmin.livecontroll',
    'BaccaratAdmin.serverinfo',
)
...
ROOT_URLCONF = 'BaccaratAdmin.urls'
...
WSGI_APPLICATION = 'BaccaratAdmin.wsgi.application'
